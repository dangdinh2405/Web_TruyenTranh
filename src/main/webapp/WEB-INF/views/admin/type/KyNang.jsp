...
<div class="list-stories">
    ...
    <ul>
        ...
        <li class="story-list" data-id="<%= story.getId() %>" itemscope="" itemtype="https://schema.org/Book">
            <a href="<%= story.getUrl() %>" title="<%= story.getTitle() %>" class="story-link">
                <img src="<%= story.getImage() %>" itemprop="image" class="cover" width="35" height="50" alt="<%= story.getTitle() %>">
            </a>
            <div class="info">
                <h3 class="title" itemprop="name">
                    <a href="<%= story.getUrl() %>" itemprop="url" title="<%= story.getTitle() %>" class="story-title">
                        <%= story.getTitle() %>
                    </a>
                </h3>
                <p itemprop="author" class="story-author">
