...
<header id="main-header">
    <div class="container">
        ...
        <div id="userPanel">
            <ul class="main-nav">
                <li>
                    <a href="http://localhost:8080/Final1_war_exploded/home/login" rel="nofollow">
                        <i class="fa-tags"></i>
                        Đăng nhập
                    </a>
                </li>
...
<div id="main" class="main" data-type="home" role="main" itemscope itemprop="mainContentOfPage">
    <div class="container">
        <div class="main-col">
            <%@ include file="normal/recommend.jsp" %>
            <%@ include file="normal/completed.jsp" %>
            <%@ include file="normal/newest.jsp" %>
        </div>

        <aside class="right-sidebar">
            <%@ include file="normal/review.jsp" %>
        </aside>
    </div>
</div>
<footer>
